...
struct CandyView: View {
    @FetchRequest(entity: Counrty.entity(), sortDescriptors: []) var countries: FetchedResults<Counrty>
...
struct AddCandyButton: View {
    ...
    var body: some View {
        Button("Add") {
            ...
            candy1.name = "Mars"
            candy1.origin = Counrty(context: viewContext)
            candy1.origin?.shortName = "UK"
            candy1.origin?.fullName = "United Kingdom"

            let candy2 = Candy(context: viewContext)
            candy2.name = "KitKat"
            candy2.origin = Counrty(context: viewContext)
            candy2.origin?.shortName = "UK"
            candy2.origin?.fullName = "United Kingdom"

            let candy3 = Candy(context: viewContext)
            candy3.name = "Twix"
            candy3.origin = Counrty(context: viewContext)
            candy3.origin?.shortName = "UK"
            candy3.origin?.fullName = "United Kingdom"

            let candy4 = Candy(context: viewContext)
            candy4.name = "Toblerone"
            candy4.origin = Counrty(context: viewContext)
